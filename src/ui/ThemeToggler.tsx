...
const ThemeToggler = () => {
  ...
  return (
    <div
      className="fixed bottom-3 right-3 z-40 sm:static"
      data-testid="theme-toggler"
    >
      {/* Mobile Theme Toggler */}
      <div className="btn btn-circle flex items-center justify-center bg-base-100 shadow-xl sm:hidden">
      ...
      <label className="hidden cursor-pointer place-items-center sm:grid">
        <input
          type="checkbox"
          value="synthwave"
          onChange={handleToggle}
